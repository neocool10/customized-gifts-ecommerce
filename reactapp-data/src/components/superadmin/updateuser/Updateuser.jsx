...
function Updateuser() {
    ...
    const loadUser = async () => {
        let response = await fetch(`http://localhost:8080/superAdmin/getUser/${userId}`, {
            method: "GET",
            headers: {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        let response = await fetch(`http://localhost:8080/superAdmin/editUser/${userId}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json",
                "Authorization": token
            ...
            <div className="container box w-x bg-body mt-4">
                <div className='pt-4 text-dec'>
                    ...
                    <Link className='text-decoration-none' to="/superAdmin/getAllUsers">
                        <i class="fa fa-backward i-size" aria-hidden="true"></i>
                    </Link>
                </div>
                <form id='addUserForm' action='' onSubmit={handleSubmit}>
                    ...
                    <div className="pt-3 ">
                        <input className="input-field"
                            value={userInfo.mobileNumber} onChange={handleInput} placeholder="Enter Mobilenumber" type="text"
                    ...
                    <div className="pt-3 ">
                        <input className="input-field disable"
                            ...
                            name="password" autoComplete='off' id="password" disabled />
                    </div >
